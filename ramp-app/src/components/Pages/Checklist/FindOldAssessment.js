...
const FindOldAssessment = (props) => {
    return (
        <div
            className="modal fade"
            id="FetchOldAssessment"
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <form
                            ...
                            noValidate
                        >
                            <h2 className="text-primary">Continue with an old assessment</h2>
                            <div className="col">
                        ...
                        <div id="error2">
                            {props.statusIdName && (
                                <ErrorFormNameDoesntExist
                                    status={props.erroHandlerIdName}
                    ...
                    <div className="modal-footer">
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                e.preventDefault();
                                props.GetChecklistById(props.checklistProps.id_name, props.userProps.user.id, props.userProps.token);
                                props.setStatusIdName(true);
